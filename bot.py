...
TELEGRAM_TOKEN = '8328270575:AAFdU_3OJbYnodPjhl56qRRq_XhsnsUUjH0'
...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # update.message.reply_text(f"Файл {file_obj.file_name} успешно загружен. Обрабатываю...")
...
def process_file(file_path: str) -> pd.DataFrame:
    ...
    df_companies['Also know as (AKA)'] = df_companies['Also know as (AKA)'].str.lower().fillna('')
    ...
    for idx, row in df_vk.iterrows():
        ...
        for company, aka in df_companies[['Полное имя', 'Also know as (AKA)']].values:
